<template>
    <UICheckbox v-model="atMousePosition" label="Positioned at the mouse" name="at_mouse_position" />
    ...
    <UIDropdown :at-mouse-position="atMousePosition">
        ...
        <template #default="{ hide }">
            <div class="divide-y divide-gray-500">
                <div class="px-4 py-2 text-color transition-colors select-none
                ...
                <div v-for="index in range(10)"
                     :key="index"
                     class="px-4 py-2 text-color transition-colors select-none hover:bg-gray-700 hover:text-white">
    ...
    <UIDropdown :at-mouse-position="atMousePosition">
        ...
        <div class="divide-y">
            <div v-for="index in range(10)"
                 :key="index"
                 class="px-4 py-2 text-color hover:text-white hover:bg-gray-700 transition-colors">
                custom content and stuff plus things {{ index + 1 }}
            </div>
        </div>
    </UIDropdown>
