<template>
    ...
    <div class="py-10 space-y-10">
        <div class="space-y-10">
            <div>
                <UINumber v-model="input" name="ui-number" label="Standard:" autofocus/>
            ...
            <UINumber v-model="input3" name="ui-text3" label="Attribute Suffix:" suffix="kg"/>
            <UINumber v-model="input3" name="ui-text3" label="Slot Suffix:">
